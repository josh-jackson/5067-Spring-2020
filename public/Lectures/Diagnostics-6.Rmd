...
If if $X_{1}$ and $X_{2}$ are correlated and $b_{2}$ is associated with ${Y_i}$ then the residual and predictor in this model will be correlated   
...
- For example, there is a percived negative association between methodological rigour and innovatevness in published articles. Is there actually a causal negative correlation? No, it is becasue both are associated with getting published. Controlling for one another introduces the incorrect negative association. 
