...
Data are available via github: 
https://github.com/josh-jackson/5067-Spring-2020/HW_1.csv
...
6. For the dummy coded model, graph a distribution of the residuals. Then test whether the residuals correlated with Y. Explain why they are/are not. 
