...
```
Example
- Get this data at the class github account: https://github.com/josh-jackson/5067-Spring-2020/tree/master/static/Lectures
]
or 
- https://bit.ly/2u2vu18
...
- R often handles model objects poorly due to them not necessarily being in a usable data frame.
